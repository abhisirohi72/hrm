            ...
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="forms-sample" method="POST" action="{{ route('save.whats_app.flow') }}">
                            @csrf
                            <div class="form-group">
                                <label for="searching_words">Searching Words</label>
                                <input type="text" class="form-control" id="searching_words" name="searching_words" placeholder="Enter Searching Words" value="{{ $details->searching_words ?? '' }}"/>
                            </div>
