...
@section('content')
    <main class="main">
        ...
        <div class="page-title dark-background" data-aos="fade"
            style="background-image: url({{ asset('storage/themes/service') . '/' . $home_service[0]->image }});">
        ...
        <section id="services" class="services section">
            ...
            <div class="container">
                ...
                <div class="row gy-4">
                    @if ($home_service)
                        @foreach ($home_service as $data)
                            <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
                                <div class="card">
                                    <div class="card-img">
                                        <img src="{{ asset('storage/themes/service').'/'.$data->image }}" alt="" class="img-fluid">
                                    </div>
                                    <h3>{{ $data->title }}</h3>
                                    <p>{{ $data->desc }}</p>
                                </div>
