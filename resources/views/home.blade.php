...
<head>
    <title>Webfintech &mdash; Innovating the Digital Future</title>
    <meta charset="utf-8">
    ...
    <link rel="stylesheet" href="{{ asset('web_frontend/css/vendor/icomoon/style.css') }}">
    <link rel="stylesheet" href="{{ asset('web_frontend/css/vendor/owl.carousel.min.css') }}">
    <link rel="stylesheet" href="{{ asset('web_frontend/css/vendor/animate.min.css') }}">
    <link rel="stylesheet" href="{{ asset('web_frontend/css/vendor/aos.css') }}">
    <link rel="stylesheet" href="{{ asset('web_frontend/css/vendor/bootstrap.min.css') }}">
    <link rel="stylesheet" href="{{ asset('web_frontend/css/vendor/jquery.fancybox.min.css') }}">
        ...
        <div class="unslate_co--site-inner">
                    ...
                    <div class="row align-items-center justify-content-between text-left">
                        ...
                        <div class="site-logo pos-absolute">
                            <a href="{{ route('home') }}" class="unslate_co--site-logo">
                                <img src="{{ asset('web_frontend/images/logo.png') }}" alt=""
                        ...
                        <div class="col-md-5 text-right text-lg-left">
                            <ul class="site-nav-ul js-clone-nav text-left d-none d-lg-inline-block">
                                ...
                                <li><a href="{{ route('e.commerce') }}" class="nav-link">Shop</a></li>
                            </ul>
                ...
                <div class="container">
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-7 mx-auto text-center">
                            <h1 class="heading gsap-reveal-hero">WEBFINTECH</h1>
                            <h2 class="subheading gsap-reveal-hero">Empowering IT. Elevating Business.</h2>
                        </div>
                ...
                <div class="filter ml-auto" id="filters">
                  ...
                  <a href="#" data-filter=".packaging">Packaging</a>
                        ...
                        <div id="posts" class="row gutter-isotope-item">
                            ...
                            <div class="item branding packaging col-sm-6 col-md-6 col-lg-4 isotope-mb-2">
                                <a href="{{ asset('web_frontend/images/work_7_a_md.jpg') }}"
                ...
                <div class="container">
                    ...
                    <div class="row mt-5 justify-content-between">
                        ...
                        <div class="col-lg-4 pr-lg-5">
                            ...
                            <p class="gsap-reveal"><a href="#"
                                    class="btn btn-outline-pill btn-custom-light">Download my CV</a></p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="unslate_co--section section-counter" id="skills-section">
                <div class="container">
                    ...
                    <div class="row pt-5">
                        <div class="col-6 col-sm-6 mb-5 mb-lg-0 col-md-6 col-lg-3" data-aos="fade-up"
                            data-aos-delay="0">
                ...
                <div class="owl-carousel testimonial-slider" data-aos="fade-up">
                    <div>
                        <div class="testimonial-v1">
                            ...
                            <div class="testimonial-author-info">
                                <img src="{{ asset('web_frontend/images/person_man_1.jpg') }}" alt="Image">
                                <h3>Eric Ingram</h3>
                    ...
                    <div>
                        <div class="testimonial-v1">
                            ...
                            <div class="testimonial-author-info">
                                <img src="{{ asset('web_frontend/images/person_man_2.jpg') }}" alt="Image">
                                <h3>Ryan Mullins</h3>
                    ...
                    <div>
                        <div class="testimonial-v1">
                            ...
                            <div class="testimonial-author-info">
                                <img src="{{ asset('web_frontend/images/person_woman_1.jpg') }}" alt="Image">
                                <h3>Erica Miller</h3>
                            ...
                            <a href="#" class="grid-item blog-item w-100 h-100">
                                <div class="overlay">
                                    <div class="portfolio-item-content">
                                        ...
                                        <p class="post-meta">By Joefrey <span class="small">&bullet;</span> 5 mins
                                            read</p>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-4">
                            <div class="contact-info-v1">
                                <div class="gsap-reveal d-block">
                                    ...
                                    <a href="#" class="contact-info-val"> info@webfintech.in</a>
                                </div>
                                <div class="gsap-reveal d-block">
                                    <span class="d-block contact-info-label">Phone</span>
                                    <a href="#" class="contact-info-val">+91-8303812139</a>
                                </div>
                                {{-- <div class="gsap-reveal d-block">
                    ...
                    <div class="col-md-7">
                        ...
                        <div class="footer-site-logo">
                            <a href="{{ route('home') }}" class="d-block">
                                <img src="{{ asset('web_frontend/images/logo.png') }}" alt=""
                                    style="width: 200px;height: auto;"><span></span>
                            </a>
                        </div>
                        ...
                        <p class="site-copyright">
                            ...
                            Copyright &copy;
                             @php echo date('Y'); @endphp WEBFINTECH DIGITAL PVT LTD. Design by <a
