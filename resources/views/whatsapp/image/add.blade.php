            ...
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form id="myForm" method="POST" action="{{ route('save.whats_app.image') }}">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="image" id="image" class="form-control"
                                    value="@if (isset($details) && $details->image != '') {{ $details->image }} @endif" placeholder="HTTP link image or base64-encoded file">
                            </div>
                            <style>
                                #editor {
                                    height: 200px;
