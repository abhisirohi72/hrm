...
class InstallController extends Controller
{
    ...
    public function saveDatabase(Request $request)
    {
        ...
        try {
            ...
            Log::info('✅ Laravel connected DB6:', [DB::connection()->getDatabaseName()]);
            // Clear config/cache
            // Artisan::call('config:clear');
            // Artisan::call('cache:clear');
            Log::info('✅ Laravel connected DB2:', [DB::connection()->getDatabaseName()]);
            ...
            Log::info('✅ Laravel connected DB4:', [DB::connection()->getDatabaseName()]);
            // 🔁 Run Laravel migration & seed using updated DB config
