...
class ContactController extends Controller
{
    ...
    public function index()
    {
        ...
        $team = $this->commonService->getAllData(Team::class, ['theme_id'=> $selected_theme->id, 'status'=>'1']);

        $theme_contact = $this->commonService->getAllData(ThemeContactUs::class, ['theme_id'=> $selected_theme->id, 'status'=>'1']);
        // echo "<pre>";
        // print_r($home_custom_data);
        // exit;
